...
handle_new_test_levels <- function(model_structure, features){
  ...
  train_names <- model_structure$model$feature_names
...
#' this function returns a structure that contains a linear model as well as
#' everything else it needs (normalization factors, levels of variables etc)
#' a predict function would need
#' @param train_structure the data structure generated by prepare_training_set
#' @export
train_linear_model <- function(train_structure){

}

#' this function takes the test structures, trains a variety of models on it
#' and combines the results in some sensible way to generate final predictions.
#' @param test_structure
#' @param test_df
#' @param num_models
#' @export
ensemble_models <- function(test_structure, test_df, num_models = 2){
