...
```{r}
hyp <- guess_hyperparameters(train_structure = train_struct, depth = 15, n_estimators = 2e5)
print(hyp)
...
pred <- tibble(Id = lin_pred$Id, SalePrice = sqrt(abs(lin_pred$SalePrice)*abs(xgb_pred$SalePrice)))
