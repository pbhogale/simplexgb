...
we use [this kernel](https://www.kaggle.com/zongtseng/recipes-caret-caretensemble-xgboost-lasso-svm) to take us through the relevant steps.

```{r}
train <- read_csv("kaggle-house-prices/train.csv") %>% clean_names()
